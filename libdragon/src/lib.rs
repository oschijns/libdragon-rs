...
impl From<core::str::Utf8Error> for LibDragonError {
    fn from(error: core::str::Utf8Error) -> Self { Self::Utf8Error { error: Some(error) } }
}
...
fn get_errno() -> u32 { unsafe { (*__getreent())._errno as u32 } }

fn get_stderr() -> *mut libdragon_sys::__FILE { unsafe { (*__getreent())._stderr } }

#[doc(hidden)]
pub fn libdragon_fprintf(msg: &str) -> i32 {
    let c_str = CString::new(msg).unwrap();
    let fmt_str = CString::new("%s").unwrap();
    unsafe { libdragon_sys::fprintf(get_stderr(), fmt_str.as_ptr(), c_str.as_ptr()) as i32 }
}
...
pub fn libdragon_printf(msg: &str) -> i32 {
    let c_str = CString::new(msg).unwrap();
    let fmt_str = CString::new("%s").unwrap();
    unsafe { libdragon_sys::printf(fmt_str.as_ptr(), c_str.as_ptr()) as i32 }
}
...
#[inline(always)]
pub fn rsp_frequency() -> u32 {
    if boot_consoletype() != 0 {
        96000000
    } else {
        62500000
    }
...
impl<'a, T> N64Pointer<'a> for [T] {
    ...
    fn cached_mut(&'a mut self) -> &'a mut Self {
        ...
        unsafe {
            ::core::slice::from_raw_parts_mut(
                (((self.as_mut_ptr() as u32) & 0x1FFF_FFFF) | 0x8000_0000) as *mut T,
                len,
            )
        }
    }
    ...
    fn cached_ref(&'a self) -> &'a Self {
        ...
        unsafe {
            ::core::slice::from_raw_parts(
                (((self.as_ptr() as u32) & 0x1FFF_FFFF) | 0x8000_0000) as *const T,
                len,
            )
        }
    }
    ...
    fn uncached_mut(&'a mut self) -> &'a mut Self {
        ...
        unsafe {
            ::core::slice::from_raw_parts_mut(
                (((self.as_mut_ptr() as u32) & 0x1FFF_FFFF) | 0xA000_0000) as *mut T,
                len,
            )
        }
    }
    ...
    fn uncached_ref(&'a self) -> &'a Self {
        ...
        unsafe {
            ::core::slice::from_raw_parts(
                (((self.as_ptr() as u32) & 0x1FFF_FFFF) | 0xA000_0000) as *const T,
                len,
            )
        }
    }
...
pub fn libdragon_text_start<T>() -> &'static mut [T] {
    unsafe {
        core::slice::from_raw_parts_mut(
            libdragon_sys::__libdragon_text_start.as_mut_ptr() as *mut _,
            0,
        )
    }
}
...
#[inline]
pub fn heap_start_addr<T>() -> &'static mut [T] { bss_end() }
...
#[inline]
pub fn sys_bbplayer() -> bool { boot_consoletype() != 0 }
...
pub fn data_cache_writeback_invalidate_all() {
    unsafe {
        libdragon_sys::data_cache_writeback_invalidate_all();
    }
}
...
pub fn inst_cache_invalidate_all() {
    unsafe {
        libdragon_sys::inst_cache_invalidate_all();
    }
}
...
#[inline]
pub fn get_memory_size() -> usize { unsafe { libdragon_sys::get_memory_size() as usize } }

/// Is expansion pak in use
///
/// See [`is_memory_expanded`](libdragon_sys::is_memory_expanded)for details.
#[inline]
pub fn is_memory_expanded() -> usize { unsafe { libdragon_sys::is_memory_expanded() as usize } }

/// Allocate a buffer that will be accessed as uncached memory
///
/// See [`malloc_uncached`](libdragon_sys::malloc_uncached)for details.
#[inline]
pub unsafe fn malloc_uncached<T>(size: usize) -> *mut T {
    libdragon_sys::malloc_uncached(size) as *mut _
}
...
#[inline]
pub unsafe fn malloc_uncached_aligned<T>(align: i32, size: usize) -> *mut T {
    libdragon_sys::malloc_uncached_aligned(align, size) as *mut _
}
...
#[inline]
pub unsafe fn free_uncached<T>(ptr: *mut T) { libdragon_sys::free_uncached(ptr as *mut _); }
...
#[inline]
pub fn get_tv_type() -> TvType { unsafe { libdragon_sys::get_tv_type().into() } }
...
#[inline]
pub unsafe fn mem_read16(vaddr: u64) -> u16 {
    let r;
    unsafe {
        asm!("dsll32 {w1}, {w1}, 0",
             "or {w0}, {w0}, {w1}",
...
#[inline]
pub unsafe fn mem_read32(vaddr: u64) -> u32 {
    let r;
    unsafe {
        asm!("dsll32 {w1}, {w1}, 0",
             "or {w0}, {w0}, {w1}",
...
#[inline]
pub unsafe fn mem_read64(vaddr: u64) -> u64 {
...
pub mod interrupts {
    ...
    pub fn set_AI_interrupt(active: bool) {
        unsafe {
            libdragon_sys::set_AI_interrupt(active as i32);
        }
    }
    /// Enable or disable the VI interrupt
    pub fn set_VI_interrupt(active: bool, line: u32) {
        unsafe {
            libdragon_sys::set_VI_interrupt(active as i32, line);
        }
    }
    /// Enable or disable the PI interrupt
    pub fn set_PI_interrupt(active: bool) {
        unsafe {
            libdragon_sys::set_PI_interrupt(active as i32);
        }
    }
    /// Enable or disable the DP interrupt
    pub fn set_DP_interrupt(active: bool) {
        unsafe {
            libdragon_sys::set_DP_interrupt(active as i32);
        }
    }
    /// Enable or disable the SI interrupt
    pub fn set_SI_interrupt(active: bool) {
        unsafe {
            libdragon_sys::set_SI_interrupt(active as i32);
        }
    }
    /// Enable or disable the SP interrupt
    pub fn set_SP_interrupt(active: bool) {
        unsafe {
            libdragon_sys::set_SP_interrupt(active as i32);
        }
    }
    /// Enable or disable the TI interrupt
    pub fn set_TI_interrupt(active: bool) {
        unsafe {
            libdragon_sys::set_TI_interrupt(active as i32);
        }
    }
    /// Enable or disable the CART interrupt
    pub fn set_CART_interrupt(active: bool) {
        unsafe {
            libdragon_sys::set_CART_interrupt(active as i32);
        }
    }
    /// Enable or disable the RESET interrupt
    pub fn set_RESET_interrupt(active: bool) {
        unsafe {
            libdragon_sys::set_RESET_interrupt(active as i32);
        }
    }
    ...
    pub fn disable() {
        unsafe {
            libdragon_sys::disable_interrupts();
        }
    }
    ...
    pub fn enable() {
        unsafe {
            libdragon_sys::enable_interrupts();
        }
    }
    ...
    #[inline]
    pub fn exception_reset_time() -> u32 { unsafe { libdragon_sys::exception_reset_time() } }
    ...
    impl From<libdragon_sys::interrupt_state_t> for InterruptsState {
        fn from(val: libdragon_sys::interrupt_state_t) -> InterruptsState {
            match val {
                libdragon_sys::interrupt_state_t_INTERRUPTS_UNINITIALIZED => {
                    InterruptsState::Uninitialized
                }
    ...
    #[inline]
    pub fn get_state() -> InterruptsState {
        unsafe { libdragon_sys::get_interrupts_state().into() }
    }
}
...
#[inline(always)]
pub fn reset_time_length() -> u32 { ticks::from_ms(200) }
