...
impl<'a> Sprite<'a> {
    ...
    pub fn load<T: AsRef<dfs::Path>>(path: T) -> Result<Self> {
        ...
        let s = unsafe { libdragon_sys::sprite_load(cpath.as_ptr()) };
    ...
    pub fn get_format(&self) -> surface::TexFormat {
        let f = unsafe {
            (*self.ptr).__bindgen_anon_1.flags & (libdragon_sys::SPRITE_FLAGS_TEXFORMAT as u8)
        };
    ...
    pub fn get_pixels(&self) -> surface::Surface<'a> {
        extern "C" {
            fn sprite_get_pixels_r(
                surface: *mut libdragon_sys::surface_t,
                sprite: *mut libdragon_sys::sprite_t,
            );
        }
    ...
    pub fn get_detail_pixels(
        &self,
        info: Option<&mut SpriteDetail>,
        parms: rdpq::TexParms,
    ) -> surface::Surface<'a> {
        extern "C" {
            fn sprite_get_detail_pixels_r(
                surface: *mut libdragon_sys::surface_t,
                sprite: *mut libdragon_sys::sprite_t,
                info: *mut libdragon_sys::sprite_detail_t,
                infoparms: *mut libdragon_sys::rdpq_texparms_t,
            );
        }
    ...
    pub fn get_palette(&self) -> rdpq::TlutPalette<'a> {
        unsafe { libdragon_sys::sprite_get_palette(self.ptr) as rdpq::TlutPalette }
    }
    ...
    pub fn get_texparms(&self) -> rdpq::TexParms {
        let mut parms: core::mem::MaybeUninit<libdragon_sys::rdpq_texparms_t> =
            core::mem::MaybeUninit::uninit();
        unsafe {
    ...
    pub fn get_lod_count(&self) -> u32 {
        unsafe { libdragon_sys::sprite_get_lod_count(self.ptr) as u32 }
    }
