...
#[inline]
pub fn present() -> EepromType { unsafe { libdragon_sys::eeprom_present().into() } }
...
#[inline]
pub fn read(block: usize) -> Vec<u8> {
...
/// See [`eeprom_read`](libdragon_sys::eeprom_read) for details
#[inline]
pub fn read_into(block: usize, dest: &mut [u8]) {
    unsafe {
...
#[inline]
pub fn write(block: usize, src: &[u8]) -> u8 {
    unsafe { libdragon_sys::eeprom_write(block as u8, src.as_ptr()) }
}
...
#[inline]
pub fn read_bytes(start: usize, len: usize) -> Vec<u8> {
...
/// See [`eeprom_read_bytes`](libdragon_sys::eeprom_read_bytes) for details
#[inline]
pub fn read_bytes_into(dest: &mut [u8], start: usize) {
    unsafe {
...
#[inline]
pub fn write_bytes(src: &[u8], start: usize) {
    unsafe {
