...
pub const IDENTIFIER_UNKNOWN: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_UNKNOWN as JoybusIdentifier;
...
pub const IDENTIFIER_NONE: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_NONE as JoybusIdentifier;
...
pub const IDENTIFIER_N64_VOICE_RECOGNITION: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_N64_VOICE_RECOGNITION as JoybusIdentifier;
...
pub const IDENTIFIER_N64_RANDNET_KEYBOARD: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_N64_RANDNET_KEYBOARD as JoybusIdentifier;
...
pub const IDENTIFIER_64GB_LINK_CABLE: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_64GB_LINK_CABLE as JoybusIdentifier;
...
pub const IDENTIFIER_GBA_LINK_CABLE: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_GBA_LINK_CABLE as JoybusIdentifier;
...
pub const IDENTIFIER_CART_RTC: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_CART_RTC as JoybusIdentifier;
...
pub const IDENTIFIER_CART_EEPROM_4KBIT: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_CART_EEPROM_4KBIT as JoybusIdentifier;
...
pub const IDENTIFIER_CART_EEPROM_16KBIT: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_CART_EEPROM_16KBIT as JoybusIdentifier;
...
pub const IDENTIFIER_N64_CONTROLLER: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_N64_CONTROLLER as JoybusIdentifier;
...
pub const IDENTIFIER_N64_MOUSE: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_N64_MOUSE as JoybusIdentifier;
...
pub const IDENTIFIER_MASK_PLATFORM: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_MASK_PLATFORM as JoybusIdentifier;
...
pub const IDENTIFIER_PLATFORM_GCN: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_PLATFORM_GCN as JoybusIdentifier;
...
pub const IDENTIFIER_MASK_GCN_CONTROLLER: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_MASK_GCN_CONTROLLER as JoybusIdentifier;
...
pub const IDENTIFIER_MASK_GCN_NORUMBLE: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_MASK_GCN_NORUMBLE as JoybusIdentifier;
...
pub const IDENTIFIER_MASK_GCN_WIRELESS: JoybusIdentifier =
    libdragon_sys::JOYBUS_IDENTIFIER_MASK_GCN_WIRELESS as JoybusIdentifier;
...
pub const IDENTIFY_STATUS_ACCESSORY_MASK: u32 =
    libdragon_sys::JOYBUS_IDENTIFY_STATUS_ACCESSORY_MASK;
...
pub const IDENTIFY_STATUS_ACCESSORY_UNSUPPORTED: u32 =
    libdragon_sys::JOYBUS_IDENTIFY_STATUS_ACCESSORY_UNSUPPORTED;
...
pub const IDENTIFY_STATUS_ACCESSORY_PRESENT: u32 =
    libdragon_sys::JOYBUS_IDENTIFY_STATUS_ACCESSORY_PRESENT;
...
pub const IDENTIFY_STATUS_ACCESSORY_ABSENT: u32 =
    libdragon_sys::JOYBUS_IDENTIFY_STATUS_ACCESSORY_ABSENT;
...
pub const IDENTIFY_STATUS_ACCESSORY_CHANGED: u32 =
    libdragon_sys::JOYBUS_IDENTIFY_STATUS_ACCESSORY_CHANGED;
...
pub const IDENTIFY_STATUS_VOICE_RECOGNITON_READY: u32 =
    libdragon_sys::JOYBUS_IDENTIFY_STATUS_VOICE_RECOGNITON_READY;
/// Joybus identify status bit that signifies the previous command had a checksum error.
pub const IDENTIFY_STATUS_COMMAND_CHECKSUM_ERROR: u32 =
    libdragon_sys::JOYBUS_IDENTIFY_STATUS_COMMAND_CHECKSUM_ERROR;
...
pub const IDENTIFY_STATUS_GCN_RUMBLE_ACTIVE: u32 =
    libdragon_sys::JOYBUS_IDENTIFY_STATUS_GCN_RUMBLE_ACTIVE;
...
impl Joybus {
    ...
    pub fn exec_cmd<T, U>(&mut self, send_data: &[T], recv_data: &mut [T]) {
        extern "C" {
            fn joybus_exec_cmd(
                port: ::core::ffi::c_int,
                send_len: ::core::ffi::c_uint,
                recv_len: ::core::ffi::c_uint,
...
pub unsafe fn exec<T, U>(inblock: &[T], outblock: &mut [U]) {
    libdragon_sys::joybus_exec(
        inblock.as_ptr() as *const _,
        outblock.as_mut_ptr() as *mut _,
    );
}
...
impl From<libdragon_sys::joybus_accessory_io_status_t> for AccessoryIoStatus {
    fn from(val: libdragon_sys::joybus_accessory_io_status_t) -> AccessoryIoStatus {
        match val {
            libdragon_sys::joybus_accessory_io_status_t_JOYBUS_ACCESSORY_IO_STATUS_OK => {
                AccessoryIoStatus::Ok
            }
            libdragon_sys::joybus_accessory_io_status_t_JOYBUS_ACCESSORY_IO_STATUS_NO_DEVICE => {
                AccessoryIoStatus::NoDevice
            }
            libdragon_sys::joybus_accessory_io_status_t_JOYBUS_ACCESSORY_IO_STATUS_NO_PAK => {
                AccessoryIoStatus::NoPak
            }
            libdragon_sys::joybus_accessory_io_status_t_JOYBUS_ACCESSORY_IO_STATUS_BAD_CRC => {
                AccessoryIoStatus::BadCrc
            }
...
impl From<libdragon_sys::joypad_accessory_type_t> for AccessoryType {
    fn from(val: libdragon_sys::joypad_accessory_type_t) -> AccessoryType {
        match val {
            libdragon_sys::joypad_accessory_type_t_JOYPAD_ACCESSORY_TYPE_NONE => {
                AccessoryType::None
            }
            libdragon_sys::joypad_accessory_type_t_JOYPAD_ACCESSORY_TYPE_UNKNOWN => {
                AccessoryType::Unknown
            }
            libdragon_sys::joypad_accessory_type_t_JOYPAD_ACCESSORY_TYPE_CONTROLLER_PAK => {
                AccessoryType::ControllerPak
            }
            libdragon_sys::joypad_accessory_type_t_JOYPAD_ACCESSORY_TYPE_RUMBLE_PAK => {
                AccessoryType::RumblePak
            }
            libdragon_sys::joypad_accessory_type_t_JOYPAD_ACCESSORY_TYPE_TRANSFER_PAK => {
                AccessoryType::TransferPak
            }
            libdragon_sys::joypad_accessory_type_t_JOYPAD_ACCESSORY_TYPE_BIO_SENSOR => {
                AccessoryType::BioSensor
            }
            libdragon_sys::joypad_accessory_type_t_JOYPAD_ACCESSORY_TYPE_SNAP_STATION => {
                AccessoryType::SnapStation
            }
...
impl Accessory {
    ...
    pub fn read(&mut self, addr: u16) -> Result<Vec<u8>> {
        ...
        let r: AccessoryIoStatus = unsafe {
            libdragon_sys::joybus_accessory_read(self.port as i32, addr, res.as_mut_ptr() as *mut _)
                .into()
        };
        match r {
    ...
    pub fn write(&mut self, addr: u16, data: &[u8]) -> Result<()> {
        ...
        let r: AccessoryIoStatus = unsafe {
            libdragon_sys::joybus_accessory_write(self.port as i32, addr, data.as_ptr() as *const _)
                .into()
        };
        match r {
