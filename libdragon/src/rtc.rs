...
impl Time {
    ...
    pub fn get() -> Option<Time> {
        let mut t: core::mem::MaybeUninit<libdragon_sys::rtc_time_t> =
            core::mem::MaybeUninit::uninit();
        let r = unsafe { libdragon_sys::rtc_get(t.as_mut_ptr()) };
        if !r {
            return None;
        }
...
#[inline]
pub fn init() -> bool { unsafe { libdragon_sys::rtc_init() } }
...
#[inline]
pub fn is_writable() -> bool { unsafe { libdragon_sys::rtc_is_writable() } }
