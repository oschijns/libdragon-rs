...
#[inline(always)]
pub fn write_cause(x: u32) {
    unsafe {
        asm!("mtc0 {x}, $13", x = in(reg) x);
    }
}
/// Alternative naming
#[inline(always)]
pub fn write_cr(x: u32) { write_cause(x) }
...
#[inline(always)]
pub fn write_index(x: u32) {
    unsafe {
        asm!("mtc0 {x}, $0", "nop", "nop", x = in(reg) x);
    }
}
...
#[inline(always)]
pub fn write_entryhi(x: u32) {
    unsafe {
        asm!("mtc0 {x}, $10", "nop", "nop", x = in(reg) x);
    }
}
...
#[inline(always)]
pub fn write_entrylo0(x: u32) {
    unsafe {
        asm!("mtc0 {x}, $2", "nop", "nop", x = in(reg) x);
    }
}
...
#[inline(always)]
pub fn write_entrylo1(x: u32) {
    unsafe {
        asm!("mtc0 {x}, $3", "nop", "nop", x = in(reg) x);
    }
}
...
#[inline(always)]
pub fn write_pagemask(x: u32) {
    unsafe {
        asm!("mtc0 {x}, $5", "nop", "nop", x = in(reg) x);
    }
}
...
#[inline(always)]
pub fn write_wired(x: u32) {
    unsafe {
        asm!("mtc0 {x}, $6", "nop", "nop", x = in(reg) x);
    }
}
...
#[inline(always)]
pub fn write_watchlo(x: u32) {
    unsafe {
        asm!("mtc0 {x}, $18", x = in(reg) x);
    }
}
...
#[inline(always)]
pub fn get_cause_ce(cr: u32) -> u32 { (cr & CAUSE_CE) >> 28 }
/// Get the exception code value from the COP0 status register value
#[inline(always)]
pub fn get_cause_exc_code(sr: u32) -> u32 { (sr & CAUSE_EXC_CODE) >> 2 }
