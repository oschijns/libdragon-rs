...
pub fn debug_assert_func_f(file: &str, line: u32, func: &str, failedexpr: &str, msg: &str) -> ! {
    ...
    unsafe {
        libdragon_sys::debug_assert_func_f(
            c_file.as_ptr(),
            line as i32,
            c_func.as_ptr(),
            c_fexpr.as_ptr(),
